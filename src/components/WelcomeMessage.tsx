...
export default function WelcomeMessage() {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-16 sm:bottom-24 right-4 sm:right-6 z-40 w-[85vw] sm:w-auto sm:max-w-xs bg-gray-900/95 backdrop-blur-sm text-white p-3 sm:p-4 rounded-xl shadow-lg border border-gray-800"
    >
      <button 
      ...
      <div className="flex items-center text-blue-400 mb-2">
        ...
        <h3 className="font-medium text-sm sm:text-base">AI Assistant Available</h3>
      </div>
